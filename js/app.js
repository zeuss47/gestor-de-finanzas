...
function abrirPagoCiclo(tarjetaId, periodo, total) {
  ...
  if (usdNominal > 0) {
    ...
    usdWrap.hidden = true;
    // Limpiar campos USD para que no quede el estado de la tarjeta anterior.
    document.getElementById('pc-usd-saldo').textContent = 'US$ 0';
    cotizInp.value = '';
    cotizInp.oninput = null;
    document.getElementById('pc-usd-equiv').textContent = '';
